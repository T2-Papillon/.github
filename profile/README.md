...
1. 대시보드 페이지
    - 기본 홈화면으로 로그인한 사용자에게 TODO 리스트, 이번주 마감 예정 프로젝트, 최근 완료 및 현재 진행 중인 프로젝트와 업무 건수를 확인할 수 있습니다.
2. 프로젝트 목록 페이지
    - 로그인한 사용자는 자신이 참여하는 프로젝트를 진행 상태별로 확인할 수 있으며, 새 프로젝트를 생성할 수 있습니다.
    - 프로젝트명, PM, 참여자를 기준으로 프로젝트를 검색할 수 있습니다.
3. 프로젝트 상세 페이지
    - 프로젝트에 대한 정보를 확인하고 프로젝트에 대한 상세 업무를 추가, 수정, 삭제 및 조회할 수 있습니다.
    - 업무명이나 담당자명으로 업무를 검색하고, 진행 상태별 필터링 및 최신순, 우선순위순으로 업무 정렬이 가능합니다.
4. 프로젝트 통계 페이지
    - 각 프로젝트의 성과와 진행 상황을 분석할 수 있습니다.
5. 통합 검색 페이지
    - 전체 프로젝트 목록이 표시됩니다.
    - 프로젝트명, PM, 참여자로 프로젝트를 검색하고, 진행 상태별 필터링 및 최신순, 우선순위순으로 프로젝트 정렬이 가능합니다.
6. 개인 프로필 페이지
